...
class InvateDialog(private val activity: Activity) : Dialog(activity, R.style.Dialog) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        share_to_qq.setOnClickListener {
            ShareUtils.shareToQQ(activity, "升学之家", "http://www.baidu.com", "分享APP")
            dismiss()
        }
        share_to_wx.setOnClickListener {
            ShareUtils.shareToWx(activity, "升学之家", "http://www.baidu.com", "分享APP")
            dismiss()
        }
        share_to_moments.setOnClickListener {
            ShareUtils.shareToMomments(activity, "升学之家", "http://www.baidu.com", "分享APP")
            dismiss()
        }
    }
